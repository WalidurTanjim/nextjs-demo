    ...
    return (
        <>
            ...
            <button
                ...
                type="button"
                className={`visible fixed right-6 top-10 z-40 order-10 block h-10 w-10 self-center rounded bg-white opacity-100  ${isSideNavOpen
            ...
            <aside
                id="nav-menu-1"
                aria-label="Side navigation"
                className={`fixed top-0 bottom-0 left-0 z-40 flex w-72 flex-col border-r border-r-slate-200 bg-white transition-transform  ${isSideNavOpen ? "translate-x-0" : " -translate-x-full"
                    }`}
            >
                <a
